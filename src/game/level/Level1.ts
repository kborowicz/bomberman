...
export default class Level1 extends Level {
    ...
    public load(): void | Promise<void> {
        ...
        this.context.player.spawnAt(1, 1);

        // const enemy1 = new PlayerEnemy(this.context);
        // enemy1.spawnAt(13, 13);

        const enemy2 = new FlashEnemy(this.context);
        ...
        const enemy5 = new PlayerEnemy(this.context);
        enemy5.spawnAt(13, 1);
    }

    private initBoard() {
        const builder = new BoardBuilder(this.context);
